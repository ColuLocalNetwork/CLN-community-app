...
const SummaryStep = ({ communityName, communityLogo, communitySymbol, totalSupply, showPopup, setIssuanceTransaction }) => {
  return [
    ...
    <div key={4} className='text-center'>
      <button onClick={showPopup} className='symbol-btn'>
        Done
      </button>
    </div>
  ]
