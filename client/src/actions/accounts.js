...
export const FETCH_MY_TOKENS = createRequestTypes('FETCH_MY_TOKENS')
...
export const fetchMyTokens = (accountAddress) => action(FETCH_MY_TOKENS.REQUEST, {accountAddress})
