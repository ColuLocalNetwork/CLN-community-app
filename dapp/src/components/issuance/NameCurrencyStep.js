...
const NameCurrencyStep = ({ setExistingToken, communityName, handleChangeCommunityName, setNextStep, setCommunityType, communityType }) => {
  return (
    <div className='name__wrapper'>
      ...
      <CurrencyType setExistingToken={setExistingToken} setCommunityType={setCommunityType} communityType={communityType} />
